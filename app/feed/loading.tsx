...
// Automatically shown by the router while the async Feed component in page.tsx
// is awaiting its first data fetch. Uses the same layout as the real page so
// there is no layout shift when the content streams in.
  ...
  return (
    <main className="min-h-screen bg-zinc-100 dark:bg-zinc-900 flex flex-col items-center pt-20 pb-10 px-4">
      <div className="w-full max-w-2xl">
        ...
        {/* Skeleton cards — same height as real PostCard rows */}
